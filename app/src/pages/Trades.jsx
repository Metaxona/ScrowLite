        ...
        {isLoading ? (
          ...
          PendingVisibility.map((item) => (
            <TradeCard
              ...
              fromTokenId={item.from[ASSET_TYPE[item.fromType].toLowerCase()]?.tokenId || item.from[ASSET_TYPE[item.fromType].toLowerCase()].tokenId === BigInt(0n) ? BigInt(item.from[ASSET_TYPE[item.fromType].toLowerCase()].tokenId).toString() : ""}
